...
const wait = cb => () => {
  const delayMs = getIntInRange(100, 500);
...
const isSuccess = () => {
  // Let's emulate request failures. Onc call in 100 will fail.
...
const data = [
  {
    ...
    units: { proteins: "g", carbs: "g", fats: "g", energy: "kcal" },
    nutrients: { proteins: 22, carbs: 13, fats: 8 },
    energy: 774,
  ...
  },
  {
    ...
    rating: { count: 150, score: 5 },
    units: { proteins: "g", carbs: "g", fats: "g", energy: "kcal" },
    nutrients: { proteins: 20, carbs: 16, fats: 6 },
    energy: 774,
    preparationTimeMinutes: 59
  },
  {
    id: "3",
    isPremium: true,
    ...
    rating: { count: 1, score: 3.5 },
    units: { proteins: "g", carbs: "g", fats: "g", energy: "kJ" },
    nutrients: { proteins: 19, carbs: 9, fats: 3 },
    energy: 774,
  ...
  },
  {
    ...
    rating: { count: 22, score: 4 },
    units: { proteins: "g", carbs: "g", fats: "g", energy: "kJ" },
    nutrients: { proteins: 20, carbs: 17, fats: 7 },
    energy: 774,
    preparationTimeMinutes: 15
  }
];

export const getRecipes = wait(async () => {
  if (!isSuccess()) {
    return {
      success: false
    };
...
export const getUserSettings = wait(() => ({
  firstName: "Jon",
  lastName: "Doe",
